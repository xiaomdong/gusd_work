...
contract PrintLimiter is LockRequestable {
    ...
    function limitedPrint(address _receiver, uint256 _value) public onlyLimitedPrinter {
        ...
        erc20Impl.confirmPrint(erc20Impl.requestPrint(_receiver, _value));//这行代码有错，由于onlyLimitedPrinter和onlyCustodian不一样，erc20Impl.requestPrint能够执行，erc20Impl.confirmPrint无法执行
